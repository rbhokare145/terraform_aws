...
module "kubeS3" {
  source                 = "github.com/rbhokare145/terraform_aws//modules/s3?ref=v2.0.0"
  bucket_name            = "${var.bucket_name}"
  bucket_versioning_mode = "${var.versioning_mode}"
}

module "kubeDynamoDB" {
  source        = "github.com/rbhokare145/terraform_aws//modules/dynamodb?ref=v2.0.0"
...
module "kubeNatGateway" {
  source           = "github.com/rbhokare145/terraform_aws//modules/natgateway?ref=v2.0.0"
...
module "kubeNodeKeyPair" {
  source     = "github.com/rbhokare145/terraform_aws//modules/keypair?ref=v2.0.0"
  key_name   = "${var.user_key_name}"
  public_key = "${var.user_public_key}"
}

module "kubeEni" {
  source              = "github.com/rbhokare145/terraform_aws//modules/eni?ref=v2.0.0"
